...
sudo docker run -d \
  ...
  -e LMCACHE_GLM_DSA_PIPELINE_SHARED_GATHERS="${LMCACHE_GLM_DSA_PIPELINE_SHARED_GATHERS:-0}" \
  ...
  -e LMCACHE_GLM_DSA_PREFETCH_SHARED_MISSES="${LMCACHE_GLM_DSA_PREFETCH_SHARED_MISSES:-0}" \
  ...
  -e LMCACHE_CSA_OWNER_KV_PACKET="${LMCACHE_CSA_OWNER_KV_PACKET:-0}" \
