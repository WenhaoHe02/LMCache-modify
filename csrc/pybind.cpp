...
PYBIND11_MODULE(c_ops, m) {
  ...
  m.def("tutti_submit_batch_sgl_read", &tutti_submit_batch_sgl_read,
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("tutti_submit_batch_sgl_read_profiled",
        &tutti_submit_batch_sgl_read_profiled, py::arg("sq_dev_ptr"),
        py::arg("cq_dev_ptr"), py::arg("sq_db_ptr"), py::arg("cq_db_ptr"),
        py::arg("sq_tail_ptr"), py::arg("q_depth"), py::arg("qid"),
        py::arg("nsid"), py::arg("staging_iovas"), py::arg("slbas"),
        py::arg("byte_lens"), py::arg("doorbell_timestamps"),
        py::arg("stream_ptr") = int64_t(0),
        py::call_guard<py::gil_scoped_release>());
  m.def("tutti_submit_indexed_sgl_read", &tutti_submit_indexed_sgl_read,
        ...
        py::arg("stream_ptr") = int64_t(0),
        py::call_guard<py::gil_scoped_release>());
  m.def("tutti_submit_indexed_sgl_read_profiled",
        &tutti_submit_indexed_sgl_read_profiled, py::arg("sq_dev_ptr"),
        py::arg("cq_dev_ptr"), py::arg("sq_db_ptr"), py::arg("cq_db_ptr"),
        py::arg("sq_tail_ptr"), py::arg("q_depth"), py::arg("qid"),
        py::arg("nsid"), py::arg("staging_page_iovas"),
        py::arg("staging_stride"), py::arg("slba_table"),
        py::arg("selected_ids"), py::arg("byte_len"),
        py::arg("doorbell_timestamps"),
        py::arg("stream_ptr") = int64_t(0),
        py::call_guard<py::gil_scoped_release>());
  ...
  m.def("tutti_poll_batch", &tutti_poll_batch, py::arg("sq_dev_ptr"),
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("tutti_poll_batch_profiled", &tutti_poll_batch_profiled,
        py::arg("sq_dev_ptr"), py::arg("cq_dev_ptr"), py::arg("sq_db_ptr"),
        py::arg("cq_db_ptr"), py::arg("cq_head_ptr"),
        py::arg("cq_phase_ptr"), py::arg("q_depth"), py::arg("n_ios"),
        py::arg("status_out"), py::arg("timed_out_ptr"),
        py::arg("max_iters"), py::arg("cqe_timestamps"),
        py::arg("observed_cids"), py::arg("stream_ptr") = int64_t(0),
        py::call_guard<py::gil_scoped_release>());
